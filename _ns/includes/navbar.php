<nav class="navbar clearfix" role="navigation">
    ...
    <div class="left">
       <h1>
          <a href="/">Vidya Kaipa</a>
       </h1>
    </div>

    <div class="right">
      <div class="navbar-buttons">
        <a href="#menu-list" id="menu-trigger">Menu</a>
        <ul id="menu-list" class="btn-group">
          ...
          <li class="case-studies"><a href="http://www.vidyakaipa.com/experiences/vidya-kaipa-marketing-experiences.pdf">Use Cases</a></li>
